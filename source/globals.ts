...
//
const APP_NAME: string    = "OS808";   // 'cause Bob and I were at a loss for a better name.
const APP_VERSION: string = "0.00";   // What did you expect?

const CPU_CLOCK_INTERVAL: number = 90;   // This is in ms (milliseconds) so 1000 = 1 second.
...
var _krnDiskDriver: TSOS.DiskSystemDeviceDriver = null;
